...
Tmk2:			TMK 明文成份二, ASCII 码编码, 长度 16 / 32 / 48 位; 
...
返回值:
				...
				<0 读取失败, 为串口通讯错误码。
*/
int __stdcall SDBReadCustomerPin(const char * CommPort, const char *ExtPort, const char * TMKIndex, const char * accNo, const char * modex, const char * timeout, char * idnum, char *
