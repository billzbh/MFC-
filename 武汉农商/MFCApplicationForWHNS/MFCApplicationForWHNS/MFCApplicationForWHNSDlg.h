...
public:
	...
	afx_msg void OnBnClickedButtonGettermid();
	afx_msg void OnBnClickedCheckmainmkchk();
	afx_msg void OnBnClickedCheckMkchk();
	afx_msg void OnBnClickedButtonInitmk();
	afx_msg void OnBnClickedButtonDownloadmk();
	afx_msg void OnBnClickedButtonDownloadworkkey();
	// 显示设备终端号
	CEdit m_TermID;
	// 主密钥分量1
	CEdit m_MK1;
